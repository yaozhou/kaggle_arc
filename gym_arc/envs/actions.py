...
SingleAction = Enum('Action', (
    'ACTION_SINGLE_SEL_COLOR_1',
    'ACTION_SINGLE_SEL_COLOR_2',# 
    'ACTION_SINGLE_SEL_COLOR_3',
    'ACTION_SINGLE_SEL_COLOR_4',
    'ACTION_SINGLE_SEL_COLOR_5',
    'ACTION_SINGLE_SEL_COLOR_6',
    'ACTION_SINGLE_SEL_COLOR_7',
    'ACTION_SINGLE_SEL_COLOR_8',
    'ACTION_SINGLE_SEL_COLOR_9',

    'ACTION_SINGLE_SEL_TARGET_COLOR_1', # 10
    'ACTION_SINGLE_SEL_TARGET_COLOR_2',
    'ACTION_SINGLE_SEL_TARGET_COLOR_3',
    'ACTION_SINGLE_SEL_TARGET_COLOR_4',
    'ACTION_SINGLE_SEL_TARGET_COLOR_5',
    'ACTION_SINGLE_SEL_TARGET_COLOR_6',
    'ACTION_SINGLE_SEL_TARGET_COLOR_7',
    'ACTION_SINGLE_SEL_TARGET_COLOR_8',# 17
    'ACTION_SINGLE_SEL_TARGET_COLOR_9',

    'ACTION_SINGLE_MOVE_TO_TARGET_UNTIL_COLISSION', # 19

    'ACTION_SINGLE_SEL_SIZE_TOP_1',
    'ACTION_SINGLE_SEL_SIZE_TOP_2',
    'ACTION_SINGLE_SEL_SIZE_TOP_3',
    'ACTION_SINGLE_SEL_SIZE_TOP_4',
    'ACTION_SINGLE_SEL_SIZE_TOP_5',

    'ACTION_SINGLE_CHANGE_COLOR_1', # 25
    'ACTION_SINGLE_CHANGE_COLOR_2',
    'ACTION_SINGLE_CHANGE_COLOR_3',
    'ACTION_SINGLE_CHANGE_COLOR_4',
    'ACTION_SINGLE_CHANGE_COLOR_5',
    'ACTION_SINGLE_CHANGE_COLOR_6',
    'ACTION_SINGLE_CHANGE_COLOR_7',
    'ACTION_SINGLE_CHANGE_COLOR_8',
    'ACTION_SINGLE_CHANGE_COLOR_9', # 33
